...
import { MetricSearchIndex } from "../search/MetricSearchIndex.js";
...
export class MetricBrowserView extends View {
  static metadata = { title: "Metrics", icon: "\u2630" };

  constructor(contextProvider) {
    super(contextProvider);
    this._searchIndex = new MetricSearchIndex(this.ctx.registry || { forEach() {} });
    this._query = "";
