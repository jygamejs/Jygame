...
const ALL_COMPONENTS = [
  { cls: Transform, schema: { x: "f32", y: "f32", rotation: "f32", scaleX: "f32", scaleY: "f32", _prevX: "f32", _prevY: "f32", _interpValid: "u8" }, hasSchema: true },
  ...
  { cls: Animation, schema: { clipId: "u16", frameIndex: "u32", elapsed: "f32", isPlaying: "u8", speed: "f32", mode: "u8", loop: "u8", stopAt: "u32" }, hasSchema: true },
